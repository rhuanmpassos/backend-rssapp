...
exports.FeedModule = FeedModule = __decorate([
    (0, common_1.Module)({
        imports: [(0, common_1.forwardRef)(() => scraper_module_1.ScraperModule)],
        controllers: [feed_controller_1.FeedController],
        providers: [
            feed_service_1.FeedService,
            {
                provide: feed_item_service_1.FeedItemService,
                useFactory: (prisma, feedService) => {
                    return new feed_item_service_1.FeedItemService(prisma, feedService);
                },
                inject: [prisma_service_1.PrismaService, feed_service_1.FeedService],
            },
        ],
        exports: [feed_service_1.FeedService, feed_item_service_1.FeedItemService],
    })
], FeedModule);
